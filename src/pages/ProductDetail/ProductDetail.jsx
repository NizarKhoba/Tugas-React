   ...
   <>
    ...
    <div className='flex gap-[30px] px-24'>
            <div className=''>
                ...
                <img src={product.imageUrl ?? (product.name ?? 'No Name')} alt={product.name ?? 'No Name'} className='block w-[700px] h-[500px] object-cover rounded-2xl'/>
            </div>
            <div className='flex flex-col gap-[20px]'>
              ...
              {product.stock > 0 ? (
                <div>
                  <Button type="button" className="inline-flex items-center justify-center gap-2 p-4 bg-red-500 text-center hover:bg-red-400 text-white active:bg-red-600 rounded-md">
